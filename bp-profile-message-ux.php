...
function bp_profile_private_message_ux_button( $button ) {
	...
	$button_divs .= '<a href="#TB_inline?width=500&height=500&inlineId=create-private-message-ux" class="thickbox" id="private-button-id" title="';
	...
	//$button_divs .=	'<input type="hidden" name="private_message_subject" id="private_message_subject" value="generic subject" />';
...
// replace the Private Message button in Nouveau template
function bp_profile_private_message_ux_button_nouveau( $buttons, $user_id, $type ) {
	...
	if ( $type == 'profile' ) {
		...
		$button_divs .=	'<input type="text" size="41" maxlength="50" name="private_message_subject" id="private_message_subject" /><br><br>';
		//$button_divs .=	'<input type="hidden" name="private_message_subject" id="private_message_subject" value="" />';		
	...
	return $buttons;
	//return array('type' => 'profile');
}
add_filter( 'bp_nouveau_get_members_buttons', 'bp_profile_private_message_ux_button_nouveau', 99, 3 );
...
function bp_profile_public_message_ux_button( $button ) {
	...
	$button_divs .= '<a href="#TB_inline?width=400&height=500&inlineId=create-public-message-ux" class="thickbox" id="public-button-id" title="';
